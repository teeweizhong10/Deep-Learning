...
root = os.path.join(ROOT_DIR, 'q2.py')
train_folder = root + '/data/groups/gomesr/DeepL_CS491/Cityscapes_data/train'
valid_folder = root + '/data/groups/gomesr/DeepL_CS491/Cityscapes_data/val'
